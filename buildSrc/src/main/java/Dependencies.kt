...
object Config {
    const val application_id = "com.hr.heart.rate.systolic.blood.pressure.firebase.hearrateandpressure"
...
object Versions {
    ...
    // Firebase
    const val firebase = "21.4.2"
    // GSON
    const val gson = "2.8.7"
    // Serialization
    const val serialize = "1.3.0"
}
...
object Firebase {
    // Firestore (версия 24.1.0 приводила к ошибке:
    // Duplicate class com.google.protobuf.ProtocolStringList found in modules protobuf-javalite-3.19.2
    const val firestore = "com.google.firebase:firebase-firestore:${Versions.firebase}"
}
