...
class MainActivityRecyclerAdapter(
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.binding.nightsTime.text = healthDateList[position].nightTime
        holder.binding.nightsPressureTop.text = "${healthDateList[position].nightsPressureTop}"
        holder.binding.nightsPressureBottom.text = "${healthDateList[position].nightsPressureBottom}"
        ...
        holder.binding.daysPressureBottom.text = "${healthDateList[position].daysPressureBottom}"
